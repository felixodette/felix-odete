        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              I believe web design can be diverse and inspiring. With a mission to present
              the possibilities of web design, I&apos;m pursuing new expressions through
              experimenting and thought. I think… 🤷‍♂️
              <br />
              <br />
